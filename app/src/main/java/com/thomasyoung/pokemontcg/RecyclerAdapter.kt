...
class RecyclerAdapter: RecyclerView.Adapter<RecyclerAdapter.ViewHolder>(){
    ...
    private var titles = listOf(
        "Base", "Jungle", "Promos", "Fossil", "Base set 2","Team Rocket",
        "Gym Heroes","Gym Challenge","Neo Genesis","Neo Discovery","Southern Islands", "Neo Revelation","Neo Destiny"
    )

    private var details = listOf(
        "Released: 01/09/1999", "Released: 06/16/1999", "Released: 07/01/1999", "Released: 10/10/1999",
        "Released: 02/24/2000", "Released: 08/14/2000", "Released: 10/26/2000", "Released: 02/24/2000",
        "Released: 02/24/2000","Released: 02/24/2000", "Released: 02/24/2000","Released: 02/24/2000",
        "Released: 02/24/2000"
    )
    private var images = listOf(
        ...
        R.drawable.rocket, R.drawable.gym1, R.drawable.gym2, R.drawable.neo, R.drawable.neo2,
        R.drawable.southern_islands, R.drawable.neo3,R.drawable.neo4
    )
